<!-- mcp-name: io.github.CSOAI-ORG/unit-converter-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/unit-converter-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/unit-converter-ai-mcp)](https://pypi.org/project/unit-converter-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/unit-converter-ai-mcp)](https://pypi.org/project/unit-converter-ai-mcp/)
...
Or: `pip install unit-converter-ai-mcp` then run the `unit-converter-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `convert_length` to …"
- "Use `convert_weight` to …"
- "Use `convert_temperature` to …"
